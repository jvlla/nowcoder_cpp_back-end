...
class Message
{
  public:
     ...
     */
    explicit Message(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Message(const Json::Value &pJson) noexcept(false);
     ...
     */
    Message(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setToIdToNull() noexcept;

    /**  For column conversation_id  */
    ///Get the value of the column conversation_id, returns the default value if the column is null
    const std::string &getValueOfConversationId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getConversationId() const noexcept;
    ///Set the value of the column conversation_id
    void setConversationId(const std::string &pConversationId) noexcept;
    void setConversationId(std::string &&pConversationId) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<Message>;
    friend drogon::orm::BaseBuilder<Message, true, true>;
    friend drogon::orm::BaseBuilder<Message, true, false>;
    friend drogon::orm::BaseBuilder<Message, false, true>;
    friend drogon::orm::BaseBuilder<Message, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<Message>;
#endif
    ...
    std::shared_ptr<int32_t> toId_;
    std::shared_ptr<std::string> conversationId_;
