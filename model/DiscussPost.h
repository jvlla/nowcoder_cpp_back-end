...
class DiscussPost
{
  public:
     ...
     */
    explicit DiscussPost(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit DiscussPost(const Json::Value &pJson) noexcept(false);
     ...
     */
    DiscussPost(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    void setCommentCountToNull() noexcept;

    /**  For column score  */
    ///Get the value of the column score, returns the default value if the column is null
    const double &getValueOfScore() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<double> &getScore() const noexcept;
    ///Set the value of the column score
    void setScore(const double &pScore) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<DiscussPost>;
    friend drogon::orm::BaseBuilder<DiscussPost, true, true>;
    friend drogon::orm::BaseBuilder<DiscussPost, true, false>;
    friend drogon::orm::BaseBuilder<DiscussPost, false, true>;
    friend drogon::orm::BaseBuilder<DiscussPost, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<DiscussPost>;
#endif
