...
class Comment
{
  public:
    ...
    const int32_t &getValueOfEntityType() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getEntityType() const noexcept;
    ///Set the value of the column entity_type
    void setEntityType(const int32_t &pEntityType) noexcept;
    ...
    const int32_t &getValueOfEntityId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getEntityId() const noexcept;
    ///Set the value of the column entity_id
    void setEntityId(const int32_t &pEntityId) noexcept;
    ...
    const int32_t &getValueOfTargetId() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getTargetId() const noexcept;
    ///Set the value of the column target_id
    void setTargetId(const int32_t &pTargetId) noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> entityType_;
    std::shared_ptr<int32_t> entityId_;
    std::shared_ptr<int32_t> targetId_;
